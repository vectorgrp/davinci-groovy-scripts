	...
	scriptTask("CreateApplicationDataTypeFromExcelList", DV_ON_FILE_PREPROCESSING_RESULT) {
		...
		code {
			...
			try
			{
				...
				def mdfAccess = ScriptApi.activeProject.getInstance(
						IMdfAccessPublishedExt)
				...
				String pathexcel = "D:/PES_8/FOSS/KnowledgeBase/CreateApplicationDataTypeFromExcelList/Input.xlsx"
					...
					if (counterRows > 1) //ignore the title
					{
						...
						if (appDataTypename != null && category != null) {
							...
							transaction{
								...
								//second package
								MIApplicationPrimitiveDataType dataType2 = mySubPkg.element.byNameOrCreate(MIApplicationPrimitiveDataType.class, "second")
								dataType2.setCategory(category)
