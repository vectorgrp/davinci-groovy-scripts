...
daVinci {
    ...
    scriptTask("CreateNewProject", DV_APPLICATION) {
        ...
        code {
            def workDir = "D:/PES_8/FOSS/Projects/by_CSP_Application_API"
    ...
    */
    scriptTask("UpdateProjectTask", DV_APPLICATION) {
        ...
        taskHelp '''CreateNewProject script task
        The task creates a project under "/UpdateProject" in the given project folder with the name "updatedProject".
        ...
        code {
            ...
            deleteProjectFolder("$workDir/UpdateProject")

            def projPath = paths.resolvePath("$workDir/UpdateProject")
